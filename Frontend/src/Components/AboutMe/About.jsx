        ...
        <div className="space-y-10">
          <div className="bg-opacity-70 rounded-lg shadow-lg p-8 transition duration-500 hover:bg-gray-100">
            ...
            <p className="text-lg leading-relaxed text-left">
              Welcome to <strong>TasteBudsTreat's!</strong> We are <strong>Ansh Bansal, Arjun Gupta, and Adarsh Sharma</strong>,
              a trio of food enthusiasts currently in our <strong>third year of Bachelor of Computer Applications (BCA)</strong> at <strong>Sri Guru Tegh Bahadur Institute of Management and IT, affiliated with Guru Gobind Singh Indraprastha University (GGSIPU).</strong> Our passion for food and technology has inspired us to create this platform, where we aim to share our love for delicious treats with food lovers everywhere. TasteBudsTreat's is here to delight your taste buds with the best culinary experiences!
            </p>
          </div>
          ...
          <div className="bg-opacity-70 rounded-lg shadow-lg p-8 transition duration-500 hover:bg-gray-100">
            ...
            <p className="text-lg leading-relaxed text-left">
              ...
              discovering and sharing delectable recipes, food tips, and culinary adventures that ignite the senses.
              From traditional dishes to innovative creations, we celebrate the diversity and richness of flavors from around the world. Whether you're a seasoned chef or a food enthusiast, <strong>TasteBudsTreat's is your go-to destination</strong> for exploring exciting, delicious, and easy-to-follow recipes that will leave you craving more.
