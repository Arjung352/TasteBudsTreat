...
function About() {
  return (
    <div className="min-h-screen text-black flex justify-center items-center p-8">
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-[70%_30%] gap-10">
        ...
        <div className="space-y-10">
          <div className=" rounded-lg shadow-lg p-8 transition duration-500 ">
            <h1 className="text-3xl mb-6 text-green-500 text-left">About Us</h1>
            <p className="text-lg leading-relaxed text-left">
              Welcome to <strong>TasteBudsTreat's!</strong> We are{" "}
              <strong>Ansh Bansal, Arjun Gupta, and Adarsh Sharma</strong>, a
              trio of food enthusiasts currently in our{" "}
              <strong>
                third year of Bachelor of Computer Applications (BCA)
              </strong>{" "}
              at{" "}
              <strong>
                Sri Guru Tegh Bahadur Institute of Management and IT, affiliated
                with Guru Gobind Singh Indraprastha University (GGSIPU).
              </strong>{" "}
              Our passion for food and technology has inspired us to create this
              platform, where we aim to share our love for delicious treats with
              food lovers everywhere. TasteBudsTreat's is here to delight your
          ...
          <div className=" rounded-lg shadow-lg p-8 transition duration-500 ">
            ...
            <p className="text-lg leading-relaxed text-left">
              At <strong>TasteBudsTreat's</strong>, we believe that food is not
              just about sustenance but a{" "}
              <strong>source of joy and togetherness</strong>. Our platform is
              dedicated to discovering and sharing delectable recipes, food
              tips, and culinary adventures that ignite the senses. From
              traditional dishes to innovative creations, we celebrate the
              diversity and richness of flavors from around the world. Whether
              you're a seasoned chef or a food enthusiast,{" "}
              <strong>TasteBudsTreat's is your go-to destination</strong> for
              exploring exciting, delicious, and easy-to-follow recipes that
              will leave you craving more. Join us in this flavorful journey and
              let your taste buds experience the ultimate treat!
            </p>
          </div>
