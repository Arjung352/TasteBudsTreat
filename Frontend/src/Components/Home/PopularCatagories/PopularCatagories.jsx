  ...
  return (
    ...
    >
      ...
      <div className=" grid grid-cols-4 gap-8">
        <div className="p-12 backdrop-filter backdrop-blur-md bg-opacity-5 border border-gray-100 bg-gray-400 px-16 shadow-md  rounded-2xl hover:scale-105 transition-all ease-in-out">
          <img
